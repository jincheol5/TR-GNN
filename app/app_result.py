...
def app_result(config:dict):
    api=wandb.Api()
    run_20=api.run(f"jcoh-research/TR-GNN/rn5j57oy")
    run_50=api.run(f"jcoh-research/TR-GNN/kycdks0b")
    run_100=api.run(f"jcoh-research/TR-GNN/5b32lll9")
    run_500=api.run(f"jcoh-research/TR-GNN/5peonjb3")
    run_1000=api.run(f"jcoh-research/TR-GNN/phy0g3ja")

    run_batch_20=api.run(f"jcoh-research/TR-GNN/9wei8uux")
    run_batch_50=api.run(f"jcoh-research/TR-GNN/gbmnkyrf")
    run_batch_100=api.run(f"jcoh-research/TR-GNN/t67f1bwi")
    run_batch_500=api.run(f"jcoh-research/TR-GNN/ssqfqi9s")
    run_batch_1000=api.run(f"jcoh-research/TR-GNN/t2re7lys")
